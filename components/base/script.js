...
components.icosocial = {
    selector: '[class*="icosocial-"]',
    styles: './components/icosocial/icosocial.css'
};
...
components.fonts = {
    selector: 'html',
    styles: 'https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Ubuntu:wght@300;400;500;700&display=swap'
};
...
components.advantage = {
    selector: '.advantage',
    styles: './components/advantage/advantage.css',
};
